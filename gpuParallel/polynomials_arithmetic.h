...
//new
EXPORT void torusPolynomialMulByXai_16(TorusPolynomial *result, int _2N, const int *a, int bitSize, const TorusPolynomial *source);
...
EXPORT void torusPolynomialAddTo_16(TorusPolynomial* result,int startIndex, int endIndex, const TorusPolynomial* poly2);
