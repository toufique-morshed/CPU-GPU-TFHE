...
EXPORT void lweKeySwitch_16(LweSample_16 *result, const LweKeySwitchKey *ks, const LweSample_16 *sample, int bitSize,
...
EXPORT void lweKeySwitch_16_2(LweSample_16 *result, const LweKeySwitchKey *ks, const LweSample_16 *sample, int nOutputs,
                              int bitSize, Torus32 ****ks_a_gpu, Torus32 ****ks_a_gpu_extended, int ***ks_b_gpu,
                              double ***ks_cv_gpu,
                              Torus32* ks_a_gpu_extendedPtr, Torus32 *ks_b_gpu_extendedPtr, double *ks_cv_gpu_extendedPtr);
